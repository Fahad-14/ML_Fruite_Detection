...
import joblib  # Import joblib for saving trained model
import os
...
# Save trained model and mappings to a joblib file
joblib.dump((clf, label_to_int, int_to_label), 'fruit_classifier.joblib')
